...
public class AddToCartButton extends DefaultCellEditor{
        ...
        ArrayList<DiscountProductImplementation> list;
    ...
    public AddToCartButton(JCheckBox checkBox, ArrayList<DiscountProductImplementation> list)
    { 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) { 
        int itemPositionOfDiscountList;
        int numberOfItemsInRow;
      
        numberOfItemsInRow =  columnNumber / 3;
        itemPositionOfDiscountList = 3 * rowNumber + numberOfItemsInRow;
        ItemID = list.get(itemPositionOfDiscountList -1).getId();
        ...
        if(isItemInTheCartList()==1){
              ...
              int updateItemTableCount = list.get(itemPositionOfDiscountList -1).getCountOfItem() - 1;
     ...
     public int isItemInTheCartList(){
        ...
        for(int i=0;i<cartItemlist.size();i++){
              ...
              if(ItemID == cartItemlist.get(i).getId()){
                    isItInCart = 1;
