...
public class DiscountItemShowingInHomePageTable  extends javax.swing.JFrame {
    ...
    public DiscountItemShowingInHomePageTable(){
  ...
  public final  void populateJTable(){
        ...
        CreateHomePageItemDetailList createHomePageItemDetailList = new CreateHomePageItemDetailList();
        ArrayList<DiscountProductImplementation> list = createHomePageItemDetailList.getDiscountItemList();
        ...
        for(int i = 0; i < list.size(); i+=3){
             ...
             if(list.get(i).getImagePath() != null){
                    ...
                    if(i<list.size()){
                     ...
                     double newPrize = list.get(i).getPrize() - (list.get(i).getPrize() * list.get(i).getDiscount());
                     String Details = "<html> <h3><b>Product name: "+list.get(i).getSportName()+" "+
                        ...
                        list.get(i).getSize()+"<br>Prize: "+newPrize+"<br><a style='text-decoration:line-through;color:blue';>"+list.get(i).getPrize()+"</a></b></h3><h1 style='color:red'>"+list.get(i).getDiscount()*100+"%</h1></html>";
                    ...
                    if((i+1)<list.size()){
                     ...
                     double newPrize = list.get(i+1).getPrize() - (list.get(i+1).getPrize() * list.get(i+1).getDiscount());
                     String Details2 = "<html> <h3><b>Product name: "+list.get(i+1).getSportName()+" "+
                        ...
                        list.get(i+1).getSize()+"<br>Prize: "+newPrize+"<br><a style='text-decoration:line-through;color:blue';>"+list.get(i+1).getPrize()+"</a></b></h3><h1 style='color:red'>"+list.get(i+1).getDiscount()*100+"%</h1></html>";
                    ...
                    if((i+2)<list.size()){
                     ...
                     double newPrize = list.get(i+2).getPrize() - (list.get(i+2).getPrize() * list.get(i+2).getDiscount());
                     String Details3 = "<html> <h3><b>Product name: "+list.get(i+2).getSportName()+" "+
                        ...
                        list.get(i+2).getSize()+"<br>Prize: "+newPrize+"<br><a style='text-decoration:line-through;color:blue';>"+list.get(i+2).getPrize()+"</a></b></h3><h1 style='color:red'>"+list.get(i+2).getDiscount()*100+"%</h1></html>";
   ...
   //     panel.add(table);// add table in panel using add() method
    ...
    public static void main(String[] args)
    {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
              new DiscountItemShowingInHomePageTable();
            }
        });
    }    
}
