...
import com.mycompany.adminpanel.ViewControllers.customerInformationViewControllers.CustomerInformationShowingInTable;
...
public class CustomerInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        name1.setBackground(new java.awt.Color(255, 102, 102));
        name1.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        name1.setText("Last Shoping Date");
        ...
        name3.setBackground(new java.awt.Color(102, 102, 255));
        name3.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        name3.setText("Top Customers");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(26, 26, 26)
                .addComponent(searchName, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26)
...
new DasboardHomePage().setVisible(true);    
    ...
    private void name3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_name3ActionPerformed
       new CustomerInformationShowingInTable(this.jTable1,"topCustomer").setUserDetails("");
    }//GEN-LAST:event_name3ActionPerformed

    private void name1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_name1ActionPerformed
        // TODO add your handling code here:
        new CustomerInformationShowingInTable(this.jTable1,"lastShopingDate").setUserDetails("");
    }//GEN-LAST:event_name1ActionPerformed

    private void nameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nameActionPerformed
        // TODO add your handling code here:
        new CustomerInformationShowingInTable(this.jTable1,"registerDate").setUserDetails("");
    }//GEN-LAST:event_nameActionPerformed

    private void searchNameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchNameKeyReleased
        // TODO add your handling code here:
        String name = searchName.getText();
        new CustomerInformationShowingInTable(this.jTable1,"searchUserDetails").setUserDetails(name);
