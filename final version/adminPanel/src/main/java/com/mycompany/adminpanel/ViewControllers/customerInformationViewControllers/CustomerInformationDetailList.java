...
public class CustomerInformationDetailList {
    ...
    public void setUserDetails(String userDetails){
        ...
        SearchCustomersDetails searchCustomersDetails = new DataRepositoryOperationFactory(CategoryOfShowingItems).getOperationActivaterForSearchUserDetails();
        searchCustomersDetails.setUserDetails(userDetails);
        customerInformations = searchCustomersDetails.OperationActivater();
        ...
        customerInformations = CustomerDetails.OperationActivater();
        }
