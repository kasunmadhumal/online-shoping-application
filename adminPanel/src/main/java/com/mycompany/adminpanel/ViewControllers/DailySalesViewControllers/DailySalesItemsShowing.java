...
public class DailySalesItemsShowing extends DefaultTableModel{
    ...
    public final void populateJTable() {
        ...
        RepositoryOperationDetailsOfSelectedDay createItemDetailListForDailySalesTable = new DataRepositoryOperationFactory(CategoryOfShowingItems).getOperationActivatorForSelectedDateDetails();
        createItemDetailListForDailySalesTable.setSelectedDate(selectedDate);
        ResultSet detailsOfDailySalesItems = createItemDetailListForDailySalesTable.OperationActivator();
