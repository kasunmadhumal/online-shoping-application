...
public class DailySales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Daily Sales SportsMan.lk");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Image", "Item Details", "Sold Count", "price", "User email", "Sold date"
            }
        ));
...
new UpdateItemTable().setVisible(true);
 ...
 new DasboardHomePage().setVisible(true);    
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DailySalesItemsShowing dailySalesItemsShowing = new DailySalesItemsShowing(jTable1,"DailySalesDetails",selectedDate);
        double totalProfit = dailySalesItemsShowing.getTotalProfit();
        String date = selectedDate.toString();
        jLabel3.setText("Date : " + date );
        jLabel4.setText("Total Profit: " + Double.toString(totalProfit));
